...
public class AtributoLogicoXml extends AtributoControl implements Xmlizable {

	public AtributoLogicoXml() {
	}

	public AtributoLogicoXml(AtributoControl componente) {
