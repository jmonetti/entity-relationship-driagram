...
public class EntidadLogicaXml extends EntidadControl implements XmlLogicizable {

	public EntidadLogicaXml() {}

	public EntidadLogicaXml(EntidadControl componente) {
	...
	public Element toXml(ModeloLogicoParserXml parser) throws Exception {
		...
		if (this.atributos.size() > 0) {
			...
			//for (Atributo atributo : this.atributos)
				//TODO atributosElement.appendChild(parser.convertirXmlizable(atributo).toXml(parser));
		}
